...
const congratsButton = createElementStyle(
  "button",
  `width:165px;height:165px;top:260px;position:absolute;border-radius:50%;color:white;background-color:${colours.em};border:none;font-weight:700;font-size:1.2em;display:none;cursor:pointer`,
  "Congratulations!"
);
// Adding snow
// for (let i = 0; i <= 30; i++) {
